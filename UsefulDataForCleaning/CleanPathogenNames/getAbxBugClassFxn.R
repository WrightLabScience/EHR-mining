bug_groups <- list(
   ...
   Enterobacterales = c("Escherichia coli", 
                        ...
                        "Morganella morganii",
                        "Proteus mirabilis", 'Proteus vulgaris', 'Proteus penneri', 'Proteus hauseri', 'Proteus species',
                        "Serratia marcescens",
                        'Providencia stuartii', 'Providencia rettgeri', 'Providencia species', 'Providencia alcalifaciens',
                        'Salmonella species', 'Salmonella typhi', 'Salmonella enterica'),
   
   NonFermGN = c("Pseudomonas aeruginosa", "Stenotrophomonas maltophilia", "Acinetobacter baumannii"),
   
   OtherGN = c(
      'Haemophilus influenzae', 
      "Bacteroides fragilis", "Bacteroides species", "Bacteroides thetaiotaomicron", 
      "Bacteroides ovatus", "Bacteroides uniformis", "Bacteroides pyogenes", 
      "Bacteroides caccae", "Bacteroides cellulosilyticus", "Bacteroides salyersia",
      'Neisseria species'
   ),
