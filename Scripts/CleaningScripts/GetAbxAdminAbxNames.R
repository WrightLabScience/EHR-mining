...
save(abx_all, file='~/Desktop/EHR/EHR-mining/UsefulDataForCleaning/antibiotic_names/abx_names_for_abxDF.Rdata')
...
save(abx_meds, file='~/Desktop/EHR/EHR-mining/UsefulDataForCleaning/antibiotic_names/abx_names_in_med_admin_vw.Rdata')
...
save(abx_meds_iv, file='~/Desktop/EHR/EHR-mining/UsefulDataForCleaning/antibiotic_names/abx_names_in_med_admin_iv_vw.Rdata')
